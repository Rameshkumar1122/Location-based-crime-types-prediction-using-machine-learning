...
if enter:
    ...
    main_ins = {
        ...
        "week": sr.dt.isocalendar().week.tolist()[0],  # Use isocalendar().week instead of week
        "weekofyear": sr.dt.isocalendar().week.tolist()[0],  # Similarly here
...
## getting the onehotencoded column of crime type category back in single column for better visualization.
